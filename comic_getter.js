...
const pgData = {
	"1": {
		...
		content: '<img src="most_beautiful_stickman.png" title="Squeeeeeeeezezing is my favorite action and you totally read that in a cute voice but I was deadpan all along. Ha!"/>',
	},
	"2": {
		title: "<h1>inconsistent man 1.5 the presequel</h1>",
		content: '<img src="inconsistent_man_the_presequel.png" title="\'So, you\'ve always been real?\' \'Yeah. Wai--\'"/>'
	},
	"3": {
		title: "<h1>weirdness - 1</h1>",
		content: '<img src="weirdness_1.png" title="you wouldn\'t believe it, but the narrator\'s actually narrating"/>'
	}
};
